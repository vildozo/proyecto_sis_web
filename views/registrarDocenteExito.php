...
<html>
	...
	<div class="ui container">
		...
		<div class="ui segment">
			<center><h1> El registro se realizó satisfactoriamente. </h1>
			<a href="registrarDocente.php" class="ui floated positive button"><i class="plus icon"></i>Nuevo Docente</a>
			<a href="gestionarDocentes.php" class="ui floated positive button"><i class="arrow right icon"></i> Ir a Docentes</a>
			</center>
		</div>
	</div>
</br>
